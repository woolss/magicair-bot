...
8.  **Привітання:** ${shouldGreet ? `Привітайся з клієнтом. Скажи: "${timeGreeting}! Радий бачити вас у MagicAir. Чим можу допомогти?"` : 'Не використовуй привітання. Просто відповідай на питання.'}
