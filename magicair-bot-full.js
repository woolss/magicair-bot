...
function isOrderMessage(text) {
  ...
  // Проверка основного заказа (действие + товар)
  ...
  if (isSpecification && (hasItem || t.includes("кольор") || /\d+/.test(t))) return true;
...
function isOrderClarification(text, chatId) {
  ...
  const clarificationPhrases = [
    "заберу з", "з якого магазину", "які саме", "скільки коштує",
    "яка ціна", "коли можна", "о котрій", "завтра", "сьогодні"
  ];
